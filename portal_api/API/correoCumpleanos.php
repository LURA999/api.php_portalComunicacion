...
$sql = "SELECT usuario,nombres, apellidoPaterno, apellidoMaterno, correo 
FROM usuario where MONTH(fechaNacimiento) = MONTH(CURRENT_DATE()) and DAY(fechaNacimiento) = DAY(CURRENT_DATE()) ";

/*
$sql = "SELECT usuario,nombres, apellidoPaterno, apellidoMaterno, correo  FROM usuario 
where usuario = 4083 ";
*/
...
while ($fila = $result->fetch_assoc()) {
    ...
    <img class=\"adapt-img\" src=\"https://www.comunicadosaraiza.com/portal_api/API/images_correo/feliz_cumple.png\" alt title width=\"600\" height=\"286\" style=\"display:block;border:0;outline:none;text-decoration:none;-ms-interpolation-mode:bicubic\"></td>
    ...
    <strong>¡Feliz Cumpleaños<br>".$fila['nombres']." ".$fila['apellidoPaterno']." ".$fila['apellidoMaterno']."!</strong></h2></td></tr>
    ...
    Te deseamos un gran día, rodeado de bendiciones y tus seres queridos. <br>Asi mismo, aprovechamos este momento para ofrecerte un agradecimiento especial <br>por tu excelente trabajo. Te apreciamos y queremos seguir viéndote crecer en todos los ámbitos.&nbsp;</p>
    </td></tr>
    ...
    $mail->isHTML(true);
    $mail->Subject = '¡Araiza te desea un feliz cumpleaños!';
    $mail->Body = $message;
    ...
    <table width=\"100%\" cellspacing=\"0\" cellpadding=\"0\" role=\"presentation\" style=\"mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px\"><tr style=\"border-collapse:collapse\">
    <td style=\"padding:0;Margin:0;position:relative\" align=\"center\">
    <img class=\"adapt-img\" src=\"https://www.araizadiamante.com/portal_api/API/images_correo/feliz_cumple.png\" alt title width=\"600\" height=\"286\" style=\"display:block;border:0;outline:none;text-decoration:none;-ms-interpolation-mode:bicubic\"></td>
    </tr><tr style=\"border-collapse:collapse\"><td class=\"es-m-txt-c\" align=\"center\" style=\"padding:0;Margin:0;padding-left:30px;padding-right:30px;padding-top:40px\"><h3 style=\"Margin:0;line-height:24px;mso-line-height-rule:exactly;font-family:tahoma, verdana, segoe, sans-serif;font-size:20px;font-style:normal;font-weight:normal;color:#666666\"><br></h3></td></tr>
    <tr style=\"border-collapse:collapse\"><td class=\"es-m-txt-c\" esdev-links-color=\"#ffffff\" align=\"center\" style=\"Margin:0;padding-top:5px;padding-bottom:15px;padding-left:30px;padding-right:30px\"><h2 style=\"Margin:0;line-height:29px;mso-line-height-rule:exactly;font-family:tahoma, verdana, segoe, sans-serif;font-size:24px;font-style:normal;font-weight:normal;color:#ca9d5d\">
    <strong>¡Feliz Cumpleaños<br>*|".$fila['nombres']."|* *|".$fila['apellidoPaterno']." ".$fila['apellidoMaterno']."|*!</strong></h2></td></tr>
    </table></td></tr></table></td>
    ...
    $headers .= 'From: <comunicacionrh@araizahoteles.com>' ."\r\n";
    $to=$fila['correo'];
    //$to='comunicacionrh@araizahoteles.com';
    //remitente del correo
    $from = 'comunicacionrh@araizahoteles.com';
    $fromName = 'Portal de Comunicación ';

    //Asunto del email
    $subject = '¡Araiza te desea un feliz cumpleaños!'; 
