      ...
      <div style=\"font-family: Arial, sans-serif; margin: 0; padding: 0; background-color: #f4f4f4;\">
        <div style=\"max-width: 600px; margin: 0 auto; padding: 20px; background-color: #ffffff; border-radius: 5px; box-shadow: 0px 0px 10px rgba(0, 0, 0, 0.1);\">
          <div style=\"text-align: center; margin-bottom: 20px;\">
            ...
            <h1>Mi experencia laboral</h1>
          </div>
          <div style=\"font-size: 16px; line-height: 1.6; margin-bottom: 20px;\">
            <p>Estimado Equipo de Soporte,</p>
            <p>Me gustaría compartir una experencia laboral para mejorar nuestros servicios. Está es mi situación laboral:</p>
            <blockquote>
              <p>".$file['experencia']."</p>
            </blockquote>
            <p>Espero que esta experencia sea útil para continuar mejorando. ¡Gracias por su atención y dedicación!</p>
          </div>
