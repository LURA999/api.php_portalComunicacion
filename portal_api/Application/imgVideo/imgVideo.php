<?php
    ...
    {
         function cantidadSlider($local){
            //.(($input["cveLocal"] == 1 || $input["cveLocal"] == 0) ? "(cveLocal = 1 or cveLocal= 0)" : "cveLocal = :cveLocal").
            $sql = $this->connect()->prepare("
                SELECT COUNT(*) +1 proxima_posicion FROM imgVideo WHERE cveLocal = :cveLocal;
            ");
