...
require __DIR__.'/PHPMailer/src/SMTP.php';
      ...
      <div style=\"font-family: Arial, sans-serif; margin: 0; padding: 0; background-color: #f4f4f4;\">
        <div style=\"max-width: 600px; margin: 0 auto; padding: 20px; background-color: #ffffff; border-radius: 5px; box-shadow: 0px 0px 10px rgba(0, 0, 0, 0.1);\">
          <div style=\"text-align: center; margin-bottom: 20px;\">
            ...
            <h1>Sugerencia para Mejoras</h1>
          </div>
          <div style=\"font-size: 16px; line-height: 1.6; margin-bottom: 20px;\">
            <p>Estimado Equipo de Soporte,</p>
            <p>Me gustaría compartir una sugerencia para mejorar nuestros servicios. Aquí está mi sugerencia:</p>
            <blockquote>
              <p>".$file['sugerencia']."</p>
            </blockquote>
            <p>Espero que esta sugerencia sea útil para continuar mejorando la experiencia del cliente. ¡Gracias por su atención y dedicación!</p>
          </div>
    ...
    $mail->addAddress('lineadeapoyo@araizahoteles.com');
    //'lineadeapoyo@araizahoteles.com'
    $mail->CharSet = "UTF-8";
    // Configurar el contenido del correo
    $mail->isHTML(true);
    $mail->Subject = $consulta["abv"].' - '.$file['asunto'];
    $mail->Body = $message;
